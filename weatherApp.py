...
LARGE_FONT_STYLE = ("Arial", 27, "bold")
...
class WeatherApp:
	...
	def create_search_widgets(self):
		entry = tk.Entry(self.search_frame, justify="center", font=SEARCH_FONT)
		entry.grid(row=0, column=0, padx=50, pady=20, sticky="nsew")
	...
	def create_description_label(self):
		label = tk.Label(self.temp_frame, font=DSIC_FONT, bg=WHITE)
	...
	def update_labels(self, weather):
		...
		img = weather.icon_png.resize((100,100))
